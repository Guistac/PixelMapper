...
namespace Fixture {
    ...
    void iterateWithDmx(flecs::entity patch, std::function<void(flecs::entity fixture, Layout&, DmxAddress&)> fn);
    void iterateInDmxUniverse(flecs::entity patch, flecs::entity universe, std::function<void(flecs::entity fixture, Layout&, DmxAddress&)> fn);
