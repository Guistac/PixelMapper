...
static const SetupScriptPreset kSetupPresets[] = {
    ...
    { "2D: Spongebob Wireframe",
      ...
      "local droops = { 15, 12, 8, 4 }          -- droop angle of branch (degrees)\n"
      ...
      "    local droop = droops[c] * math.pi / 180\n"
      "    local alpha_tip = alpha + droop\n"
      ...
      "        \n"
      "        -- Tip direction vector (with droop angle added)\n"
      "        local bx_tip = math.sin(alpha_tip) * dx\n"
      "        local by_tip = -math.cos(alpha_tip)\n"
      "        local bz_tip = math.sin(alpha_tip) * dz\n"
      "        \n"
      "        -- Tip attachment point (starts from mid, extends distMidToTip along bx_tip vector)\n"
      "        local tipX = midX + distMidToTip * bx_tip\n"
      "        local tipY = midY + distMidToTip * by_tip\n"
      "        local tipZ = midZ + distMidToTip * bz_tip\n"
      "        \n"
      ...
      "            -- DRAW DUMMY BRANCH STRUCTURE (Base to Mid and Mid to Tip)\n"
      "            local branchStructMidName = \"Floor_\"..c..\"_Struct_Branch_\"..b..\"_BaseToMid\"\n"
      "            local fStructMid = patch:create_line(branchStructMidName, plantX, plantY, plantZ, midX, midY, midZ, 0, 0)\n"
      "            fStructMid:set_dmx(98, b)\n"
      "            \n"
      "            local branchStructTipName = \"Floor_\"..c..\"_Struct_Branch_\"..b..\"_MidToTip\"\n"
      "            local fStructTip = patch:create_line(branchStructTipName, midX, midY, midZ, tipX, tipY, tipZ, 0, 0)\n"
      "            fStructTip:set_dmx(98, b)\n"
      "            \n"
      ...
      "            local fRing = patch:create_line(ringName, plantX, plantY, plantZ, nextX, nextY, nextZ, 0, 0)\n"
      "            fRing:set_dmx(99, b)\n"
      "        end\n"
      "    end\n"
      "end" }
